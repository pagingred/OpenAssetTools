...
namespace
{
    TEST_CASE("RawLoaderGlasses(T5): Returns no action when file is missing", "[t5][glasses][assetloader]")
    {
        ...
        auto loader = glasses::CreateRawLoaderT5(memory, searchPath);
        REQUIRE_FALSE(loader->CreateAsset("mp_estate", context).HasBeenSuccessful());
    }

    TEST_CASE("RawLoaderGlasses(T5): Can parse glasses file", "[t5][glasses][assetloader]")
    {
        MockSearchPath searchPath;
    ...
    TEST_CASE("RawLoaderGlasses(T5): Empty values produce zero", "[t5][glasses][assetloader]")
    {
        MockSearchPath searchPath;
        searchPath.AddFileData(
            "glasses/mp_estate",
    ...
    TEST_CASE("RawLoaderGlasses(T5): Unknown keys are ignored", "[t5][glasses][assetloader]")
    {
        MockSearchPath searchPath;
        searchPath.AddFileData(
            "glasses/mp_estate",
