...
namespace IW6
{
    ...
    CommonAssetType CommonAssetTypeMapper::GameToCommonAssetType(const asset_type_t gameAssetType) const
    {
        static CommonAssetType lookupTable[static_cast<unsigned>(ASSET_TYPE_COUNT)]{
            ...
            CommonAssetType::ANIMCLASS,            // ASSET_TYPE_ANIMCLASS
            ...
            CommonAssetType::NET_CONST_STRINGS,    // ASSET_TYPE_NET_CONST_STRINGS
...
#define MAP_COMMON(common, game)                                                                                                                               \
    case common:                                                                                                                                               \
        ...
        switch (commonAssetType)
        {
            ...
            MAP_COMMON(CommonAssetType::ANIMCLASS, ASSET_TYPE_ANIMCLASS)
            ...
            MAP_COMMON(CommonAssetType::NET_CONST_STRINGS, ASSET_TYPE_NET_CONST_STRINGS)
            ...
            MAP_COMMON(CommonAssetType::TYPE_DOPPLER_PRESET, ASSET_TYPE_DOPPLER_PRESET)
