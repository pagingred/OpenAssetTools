...
namespace
{
    class FlameTableLoaderT5 final : public flame_table::AbstractFlameTableLoader<SubAssetFlameTable>
    {
    public:
...
namespace weapon
{
    ...
    {
        return std::make_unique<FlameTableLoaderT5>(memory, searchPath);
    }
} // namespace weapon
