#include "RawLoaderMenuListIW3.h"
...
namespace
{
    ...
    constexpr unsigned WINDOW_FLAG_OUT_OF_BOUNDS_CLICK = 0x2000000U;
    constexpr unsigned WINDOW_FLAG_POPUP = 0x1000000U;
...
namespace menu
{
    std::unique_ptr<AssetCreator<IW3::AssetMenuList>> CreateRawLoaderMenuListIW3(MemoryManager& memory, ISearchPath& searchPath)
    {
