...
namespace
{
    class FlameTableLoaderT4 final : public flame_table::AbstractFlameTableLoader<SubAssetFlameTable>
    {
    public:
            ...
            for (auto* pair : tree->pair())
            {
                         ...
                         || key == "flameCooldownSound")
                {
                    ...
                    else
                    {
                        ...
                        snd->name = name;
                        registration.AddIndirectAssetReference(context.LoadIndirectAssetReference<AssetSound>(value));
                    }
                }
            }
...
namespace weapon
{
    ...
    {
        return std::make_unique<FlameTableLoaderT4>(memory, searchPath);
    }
} // namespace weapon
